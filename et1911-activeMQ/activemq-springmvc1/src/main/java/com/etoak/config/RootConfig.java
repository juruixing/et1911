...
@Configuration //<beans> 表示这是一个root容器
@ComponentScan(
...
public class RootConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/et1909");
	...
	public SqlSessionFactoryBean sqlSession() {
		SqlSessionFactoryBean sqlSession = new 
				SqlSessionFactoryBean();
		//数据源 typeAliasesPackage MapperLocation plugins
