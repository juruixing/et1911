 ...
 * 2020-01-15T11:46:27.292+08:00
 * Generated source version: 3.1.18
 * 
 */
@WebServiceClient(name = "UserServiceService", 
                  wsdlLocation = "http://localhost:9090/user?wsdl",
...
public class UserServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9090/user?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9090/user?wsdl");
        }
        WSDL_LOCATION = url;
    }
